    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          group_by: {
            type: "string",
            description: "分组维度（ticket_analysis和deep_analysis都需要）：status/service_group/assignee/department/org/source_channel/fault_group/cause_category/business_system/weekly/monthly/sla/resolver/recurring/root_cause/ops_quality/symptom_solution/requester/nature_trend",
          },
          chart_type: {
            type: "string",
...
- group_by: 按什么维度分组（status/service_group/assignee/department/org/source_channel/fault_group/cause_category/business_system/weekly/monthly/sla/resolver/recurring/root_cause/ops_quality/symptom_solution/requester/nature_trend）
...
- group_by: 分析的主要维度（必须设置）：root_cause/recurring/ops_quality/symptom_solution/requester/org/sla/weekly/monthly 等
